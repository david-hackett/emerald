...
var appSettings = {
    ...
    everlive: {
        apiKey: 'rC5P0fPJzaYlCEFS', // Put your Backend Services API key here
        scheme: 'http',
        url: ''
    },

    eqatec: {
        productKey: 'f8a07d59aede4122b78710cc45a0e8e6',  // Put your EQATEC product key here
        version: '1.0.0.0' // Put your application version here
    },
    
    feedback: {
        apiKey: 'fb6204d0-719c-11e5-88f3-41ea7bc95430',  // Put your AppFeedback API key here
        options: {
            enableShake: true,
